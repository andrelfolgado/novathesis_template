...
%         You may use "\\" to force line breaks
\nttitle(sub,en){Managing Growing share of Renewables Production risk\\ and its Finantial implications}%
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){Miguel Fonseca, Assistant Professor, NOVA University Lisbon}
% Co-advisers(s)
\ntaddperson{adviser}(c,m){Ricardo Covas, Director, EDP - Global Energy Management}

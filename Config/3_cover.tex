...
\nttitle(main,en){Hedging Renewables Energy Generation}%
...
%-------------------------------------------------------------------
\ntauthorname(m){André Gonçalo Liberato Folgado}{Andre Folgado}
...
% SYNTAX: \ntdate(submisison){year-month-day}       \ntdate(exam){year-month-day}
%         If <month> is a number, it will be converted to the month
%                   name in the cover language.
%-------------------------------------------------------------------
%Replay with your submisison and exam dates in format YYYY-MM-DD
\ntdate(submission){2024-02-28}
\ntdate(exam){2024-02-28}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){Doctor Miguel Fonseca, Assistant Professor, NOVA University Lisbon}
% Co-advisers(s)
\ntaddperson{adviser}(c,m){Doctor Ricardo Covas, Director, EDP - Global Energy Management}

...
\begin{xltabular}{\textwidth}{Xccccc}
  ...
  \midrule
Connection~\cite{mahoney_modeling_2016}     & 2       & 2          & 1          & \emph{C}              & 1 \\
Coordinates'03~\cite{ramos_pricing_2014}   & 1        & 4          & 1          & \emph{2B, 1C}          & 0 \\
Local Variable~\cite{casula_electricity_2021}    & 1        & 2          & 1          & \emph{A}              & 0 \\
NASA~\cite{fiorenzani_quantitative_2006}              & 1        & 1          & 1          & ---                    & 0 \\
Coordinates'04~\cite{benth_quantitative_2014}    & 1        & 4          & 1          & \emph{3C}              & 0 \\
Buffer~\cite{benth_quantitative_2014}            & 0        & 7          & 0          & \emph{2A, 1B, 2C, 2D}  & 0 \\
Double-Check~\cite{benth_quantitative_2014}      & 0        & 2          & 0          & \emph{1A, 1B}          & 0 \\
StringBuffer~\cite{benth_quantitative_2014}  & 1        & 0          & 0          & ---                    & 1 \\
Account~\cite{benth_quantitative_2014}          & 1        & 1          & 1          & ---                   & 0 \\
Jigsaw~\cite{benth_quantitative_2014}            & 1        & 2          & 1          & \emph{C}              & 0 \\
Over-reporting~\cite{benth_stochastics_2016}    & 0        & 2          & 0          & \emph{1A, 1C}          & 0 \\
Under-reporting~\cite{benth_stochastic_2023}  & 1        & 1          & 1          & ---                    & 0 \\
Allocate Vector~\cite{ali_pricing_2023}  & 1        & 2          & 1          & \emph{C}              & 0 \\
Knight Moves~\cite{csercsik_strategic_2021}   & 1        & 3          & 1          & \emph{2B}              & 0 \\
  \midrule
  \rowcolor{Gainsboro}%

...
\section{Wind Power}
    ...
    \begin{enumerate}
        ...
        \item The power curve provided by the manufacture, which will determine the production between the threshold.
        \item The hub height, $h$, at which the wind power is generated.
        \item The spacial factor to differentiate turbine surroundings.
    \end{enumerate}
...
%        \frac{\text{Energy generated at period t}}{\text{Nominal Capacity Production at time t}} =
    ...
    Although, the perception of the portolio's wheight is conceptiionally different when applied to in the finantial context,
    where the weight is the percentage of the invested capital under management.
    This linear relationship between the portfolio's capacity factor and the individual assets' capacity factors,
    allows to use a yield equivalent to the Markowitz portfolio theory~\cite{thomaidis_handling_2023}.
